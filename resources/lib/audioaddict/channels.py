...
from audioaddict.listitem import configure_channel_list_item
...
def create_list_item(channel, track=None):
    list_item = xbmcgui.ListItem(label=channel.name)
    configure_channel_list_item(list_item, channel, track=track)
